...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    public boolean supports(MethodParameter mp, Class<? extends HttpMessageConverter<?>> type) {
        return mp.getMethod().getName().equals("postAccessToken"); //Permite que seja intercetado apenas 
        //quando estivesmos a trabalhar com o post
    }
    ...
    public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter mp,
        ...
        HttpServletRequest req = ((ServletServerHttpRequest) shr).getServletRequest();
        HttpServletResponse resp = ((ServletServerHttpResponse) shr1).getServletResponse();
